...
## 🎯 Usage
- 1️⃣ Log in as the Super Admin.
- 2️⃣ Use the sidebar to navigate between Admins, Doctors, Scan Centers, Features, and Metadata.
- 3️⃣ Add or edit records using the provided forms.
- 4️⃣ Assign features to admins and doctors according to your organization’s needs.
